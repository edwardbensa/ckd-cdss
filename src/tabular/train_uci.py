...
# Load dataset
df = pd.read_csv(INTERIM_DATA_DIR / "tabular_data/ucickd_train.csv")
...
# Save model
model_dir = Path(MODELS_DIR / "ucimlrepo_ckd")
model_dir.mkdir(parents=True, exist_ok=True)

timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
model_path = model_dir / f"xgb_uci_ckd_{timestamp}.joblib"
