...
IMAGES_DIR = IMAGES_DIR.parents[2] / "dipstick_test/no_aug"
...
def main():
    ...
    for img_path in IMAGES_DIR.iterdir():
        ...
        results = read_dipstick(img_path, sample_method='cw')
    ...
    results_path = RESULTS_DIR / "model_readings_no_aug(full).json"
